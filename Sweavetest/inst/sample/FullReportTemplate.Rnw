...
library(Sweavetest)
library(tables)
setwd("C:/Users/Adam Rahman/Desktop/Summer Project/Test Templates")
newCommands()
Version <- version("Teacher")
testversion <- 4
NumberOfVersions <- 4

if(Version == "Report"){
  scanex <- readScanex("fakescans.dat")
}
...
\markright{"Your Class Name Here" Exam \Sexpr{versioncodes[testversion]}}
...
\begin{center}
\fbox{\bf EXAM CODE \Sexpr{ExamNum[testversion]}}
\end{center}
\vspace{0.5in}
...
\item { Fill in and {\bf code} your STUDENT NUMBER, SECTION and EXAM CODE on the Scantron sheet.  Your EXAM CODE is  \Sexpr{ExamNum[testversion]}.  }

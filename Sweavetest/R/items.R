items <-
function(..., Correct=1, KeepLast=0, CheckDups, Answers, testversion, randomize, Index,
         QuestionCounter,QuestionIndex, DR, ID, PB, AnswerCountMatrix, GradedTests, fignum,correct, Version) {
